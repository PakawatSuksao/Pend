...
$result_equipmenmt_type = mysqli_query($conn, "select * from equipment_type");
    ...
    <div class="container">
        <main class="px-md-4 py-4">
                ...
                <div class="card-body">
                    ...
                    <form method="post">
                        <select class=" my-2 mx-1 mb-lg-0 col-sm-2" name="report_id" required>
                            <option value="">-- เลือกประเภทอุปกรณ์กีฬา --</option>
                            <?php

                            while ($row_equipment_type = mysqli_fetch_array($result_equipmenmt_type)) {
                            ?>
                                <option value="<?php echo $row_equipment_type['equipment_type_id'] ?>"><?php echo $row_equipment_type['equipment_type_name'] ?></option>
                            <?php } ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $query = mysqli_query($conn, "SELECT equipment_type_id, member_id as x,count(borrow_id) as y FROM borrow
                            WHERE end_date BETWEEN '$txtStartDate' and '$txtEndDate' and equipment_type_id = '$id'  
                            GROUP BY member_id
                            ...
                            ");
                                ...
                                while ($row = mysqli_fetch_array($query)) {
                                    ...
                                    $brand_id_row = $row['equipment_type_id'];
                                    $brand_p = "SELECT * FROM equipment_type WHERE equipment_type_id = '$brand_id_row' ";
                                    $brand_p_run = mysqli_query($conn, $brand_p);
                                    foreach ($brand_p_run as $brand_row) {
                                        $brandname1 = $brand_row['equipment_type_name'];
                                    }
            ...
            <div class="card" style="background-color: 8FB7DB;">
                ...
                <div class="card-body">
                    <form action="../report_borrow.php" method="post" enctype="multipart/form-data">
                        ตั้งแต่ :
                    ...
                    <hr>
                    <form action="../reportall_borrow.php" method="post" enctype="multipart/form-data">
