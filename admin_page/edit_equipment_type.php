...
$query = "SELECT * FROM equipment_type WHERE equipment_type_id = '$id'";
...
background-size: cover; 
 ">
    ...
    <div class="container">
        <center>
            <h1> แก้ไขข้อมูลประเภทอุปกรณ์กีฬา </h1>
        </center>
                ...
                <form method="POST" action="update_equipment.php" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            ?>
                                <input type="hidden" name="updatetype_id" value="<?php echo $row['equipment_type_id']; ?>" required>
                                ชื่อประเภทอุปกรณ์
                                <input type="text" name="name" class="form-control" value="<?php echo $row['equipment_type_name'] ?>" required>
                                <br>
                                ...
                                <div class="modal-footer">
                                    <a class="btn btn-secondary" href="equipment_type_manage.php">ปิด</a>
