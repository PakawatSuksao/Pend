    ...
    <div class="container">
        <main class="px-md-4 py-4">
                ...
                <div class="col-10 col-md-10 col-lg-12 mb-lg-0">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            $msg = "ข้อมูลการจองสนามทั้งหมด";
                            $dataPoints = array();
                            $result = mysqli_query($con, "
                            SELECT stadium_type_id as x,count(booking_id) as y FROM booking
                            WHERE status = 1
                            GROUP BY stadium_type_id
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                foreach ($brand_p_run as $brand_row) {
                                    $brandname = $brand_row['stadium_type_name'];
                                }
                            ...
                            if (isset($_POST['search'])) {
                                ...
                                $msgequipment = "ข้อมูลการจองสนาม ตั้งเเต่ ";
                                $msg = "$txtStartDate ถึง $txtEndDate";
                                $query = mysqli_query($con, "SELECT stadium_type_id as x,count(booking_id) as y FROM booking
                                WHERE start_date BETWEEN '$txtStartDate' and '$txtEndDate'
                                GROUP BY stadium_type_id
                                ORDER BY stadium_type_id
                           ");
            ...
            <div class="card" style="background-color: 8FB7DB;">
                ...
                <div class="card-body">
                    <form action="../report_booking.php" method="post" enctype="multipart/form-data">
                        ตั้งแต่ :
                    ...
                    <hr>
                    <form action="../reportall_booking.php" method="post" enctype="multipart/form-data">
