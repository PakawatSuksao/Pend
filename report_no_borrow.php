...
$fileName = "ข้อมูลอุปกรณ์ที่ยังไม่คืน" . $start . "ถึง" . $end .  ".csv";
...
$query = $conn->query("SELECT * FROM borrow WHERE start_date >= '$start' and start_date <= '$end' and status = 0 ORDER BY start_date ASC");
if ($query->num_rows > 0) {
