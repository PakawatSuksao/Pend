...
$fileName = "ข้อมูลการจองสนาม" . $start . "ถึง" . $end .  ".csv";
...
$query = $conn->query("SELECT * FROM booking WHERE start_date >= '$start' and start_date <= '$end' and status = 1 ORDER BY start_date ASC");
if ($query->num_rows > 0) {
