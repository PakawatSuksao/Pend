...
background-size: cover">
    ...
    <?php endif ?>
    <?php if (isset($_SESSION['maxd_check'])) : ?>
        <center>
            <div style="font-size: 25px;" class="alert alert-danger user_check">
                <?php
                echo $_SESSION['maxd_check'];
                unset($_SESSION['maxd_check']);
                ?>
            </div>
        </center>
    <?php endif ?>
    <?php if (isset($_SESSION['notpdf'])) : ?>
        <center>
            <div style="font-size: 25px;" class="alert alert-danger user_check">
                <?php
                echo $_SESSION['notpdf'];
                unset($_SESSION['notpdf']);
                ?>
            </div>
        </center>
    <?php endif ?>
        ...
        <div class="modal fade" id="booking_1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php if ($_SESSION['member_type'] == "user") { ?>save_booking_user.php  <?php } else { ?> save_booking_student.php <?php } ?>" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <hr>
                                <br>
                                <input type="text" name="people" class="form-control" placeholder="จำนวนคน" maxlength="10" required>
                                <br>
                                ...
                                แนบไฟล์เอกสารการขอใช้สนาม (<font color="red">*</font>pdf)
                                <hr>
                                ...
                                <br>
                                <font color="red">*</font>กรุณาจองล่วงหน้า 5 วันเป็นอย่างต่ำ
                                <br>
                                <font color="red">*</font>ช่วงเช้า(8.30-12.00) ช่วงบ่าย(12.00-16.00) ช่วงค่ำ(16.00-20.00)
                                <br>
                    ...
                    <form method="POST" action="<?php if ($_SESSION['member_type'] == "user") { ?>save_booking_user.php  <?php } else { ?> save_booking_student.php <?php } ?>" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <font color="red">*</font>กรุณาจองล่วงหน้า 5 วันเป็นอย่างต่ำ
                                <br>
                                <font color="red">*</font>สมารถจองได้สูงสุด 5 วัน ต่อ การจอง 1 ครั้ง
